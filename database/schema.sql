...
(
    ...
    has_parking  tinyint  default 0                 null comment '是否有车位: 0-无 1-有',
...
(
    ...
    repair_type      varchar(32)                        not null comment '报修类型名称(水电维修、家具维修等)',
    ...
    status           tinyint  default 0                 null comment '状态: 0-待派单 1-已派单 2-处理中 3-已完成 4-已取消 5-已关闭',
...
(
    ...
    community_id   bigint                             null comment '所属小区ID（管理员绑定小区）',
    is_deleted     tinyint  default 0                 null comment '删除标记: 0-未删除 1-已删除',
    version        int      default 0                 null comment '乐观锁版本号',
    create_time    datetime default CURRENT_TIMESTAMP null comment '创建时间',
    update_time    datetime default CURRENT_TIMESTAMP null on update CURRENT_TIMESTAMP comment '更新时间',
