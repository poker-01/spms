...
const handleAdd = () => {
  ...
  resetForm()
  form.communityId = communityId.value || null
...
const handleDelete = (row: any) => {
  ElMessageBox.confirm(`确定要删除楼栋「${row.buildingName}」吗？`, '提示', {
  ...
  <div class="page-container">
    ...
    <div class="page-header">
      <div class="page-header__left">
        ...
        <span class="page-subtitle">管理各小区楼栋信息</span>
      </div>
      ...
      <div class="search-section__inner">
        <div class="search-row">
          <div class="search-row__item">
            <label class="search-row__label">楼栋名称</label>
            <input v-model="searchForm.buildingName" placeholder="请输入楼栋名称" class="form-input" />
          </div>
          <div class="search-row__item">
            <label class="search-row__label">所属小区</label>
            <select v-model="searchForm.communityId" class="form-select">
      ...
      <div class="table-wrap">
        <table class="table">
          ...
          <tr>
            ...
            <th style="width: 140px;">楼栋编码</th>
            <th style="min-width: 120px;">楼栋名称</th>
            <th style="min-width: 120px;">所属小区</th>
            <th style="width: 80px;">总楼层</th>
          ...
          <tr v-for="row in tableData" :key="row.id">
            <td>{{ row.id }}</td>
            <td><span class="tag tag-code">{{ row.buildingCode }}</span></td>
        ...
        <div class="dialog__body">
          <div class="form-grid">
            <div class="form-field full-width">
              <label class="form-label required">所属小区</label>
              <select v-model="form.communityId" class="form-select">
                <option v-for="item in communityOptions" :key="item.id" :value="item.id">
                  {{ item.communityName }}
                </option>
              </select>
            ...
            <div class="form-field">
              <label class="form-label">楼栋编码</label>
              <input v-model="form.buildingCode" class="form-input" placeholder="请输入楼栋编码" />
            </div>
            <div class="form-field">
              <label class="form-label required">楼栋名称</label>
              <input v-model="form.buildingName" class="form-input" placeholder="请输入楼栋名称" />
            </div>
            <div class="form-field">
              <label class="form-label">总楼层</label>
              <input v-model.number="form.totalFloors" class="form-input" type="number" min="0" />
            </div>
            <div class="form-field">
